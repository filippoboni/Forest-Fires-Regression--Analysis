...
Let's visualize better the number of zero values of the *area* variable (representing a burned area smaller than $100 m^2$) with respect to the number of values greater that zero.
```{r}
big_fire <- rep("No",length(fires$X))
big_fire[fires$area>0] <-"Yes"
ggplot(fires,aes(x=big_fire))+
